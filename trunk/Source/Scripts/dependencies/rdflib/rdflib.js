...
$rdf.Util = {
    ...
    ** Also note that a , in a header value is just the same as having two headers.
    ...
    // This library does not exist in FF 17.0.1 anymore (&& netscape.security.PrivilegeManager.enablePrivilege) 
    'enablePrivilege': ((typeof netscape != 'undefined') ) || function() { return; }, //&& netscape.security.PrivilegeManager.enablePrivilege
    'disablePrivilege': ((typeof netscape != 'undefined') ) || function() { return; }, //&& netscape.security.PrivilegeManager.enablePrivilege
